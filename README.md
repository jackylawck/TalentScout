...
> **Enterprise Talent Advisory & ISO 42001 Compliance Audit System**  
> **企業級人才決策與 ISO 42001 / AIGP Risk 合規審計系統**
...
![Governance](https://img.shields.io/badge/AI_Governance-ISO_42001_%7C_AIGP-orange)
...
### 🇭🇰 繁體中文
**慧聘 · 智析官 (TalentScout AI)** 是一個專為高階 HR 負責人、董事局顧問與用人主管（Line Managers）打造的企業級人才評估與 AI 治理合規系統。

不同於傳統僅給出模糊評分的招募工具，TalentScout AI 結合了**人才科學 (Talent Science)**、**香港 PDPO 私隱規範**，以及 **ISO 42001 / AIGP 高風險 AI 系統管理標準**。系統提供可追溯的履歷證據鏈 (Evidence Table)、反證機制 (Counter-Evidence)、硬/軟風險分層，以及具備 Strong/Red-Flag 辨識力的結構化 STAR 行為面試題庫。
...
* **⚖️ 高風險 AI 合規 (EU AI Act & ISO 42001):** 將招募 AI 定位為「高風險 AI 系統」，落實決策透明度 (Transparency) 與人類監督 (Human-in-the-Loop, HITL) 防護網。

---

## 🌟 核心特色 (Key Features)

| 特色模組 (Module) | 說明 (Traditional Chinese) | Description (English) |
| :--- | :--- | :--- |
| **📊 五維分數拆解** | 拒絕黑盒分數，拆解硬性條件、核心能力、行業匹配、風格與風險扣分。 | 5-subscore analytics breaking down Hard Req, Competency, Industry Fit, Culture, & Risks. |
| **📜 可追溯證據鏈** | 每項評價皆附帶履歷原文精確引用 (Quotes) 與來源段落，符合 ISO 42001 Audit Trail。 | Verbatim CV quotes & source mapping ensuring 100% traceability under ISO 42001. |
...
* **Governance Framework:** ISO/IEC 42001 (AIMS), IAPP AIGP Body of Knowledge, EU AI Act High-Risk AI System Guidance
